...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\workspace\\film\\guns-movie\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("ClaireWang");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_movie?serverTimezone=GMT&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"mtime_actor_t","mtime_banner_t","mtime_cat_dict_t","mtime_film_actor_t","mtime_film_info_t","mtime_film_t","mtime_source_dict_t","mtime_year_dict_t"});
