...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\workspace\\film\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_user?serverTimezone=GMT&characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"mtime_user_t"});//你要逆向工程哪张表
